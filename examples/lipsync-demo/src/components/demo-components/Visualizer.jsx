...
export const Visualizer = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      if (lipsyncRef.current) {
        const { viseme, features } = lipsyncRef.current.processAudio();
  ...
  return (
    <>
      <section className="bg-white p-10 min-h-full">
        <div className="max-w-2xl mx-auto p-4 flex flex-col gap-4">
          <section className="flex flex-col gap-4">
            <h1 className="text-5xl font-bold text-center">Visualizer</h1>
          ...
          <div className="pointer-events-auto p-4 flex flex-col gap-4">
